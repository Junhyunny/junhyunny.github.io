...
category:
  - information
last_modified_at: 2021-05-22T12:00:00
---

<br>

## HTTP 비연결성(Connectionless) 특징
이번 포스트 주제인 HTTP Keep-Alive 헤더 속성에 대해 설명하기 전에 등장하게 된 배경부터 설명해보려고 합니다. 
Keep-Alive 헤더 속성은 지난 [HTTP(HyperText Transfer Protocol)][http-blog-link] 포스트에서 소개한 HTTP 특징 중 한가지인 비연결성(Connectionless)과 연관있습니다. 
...
서버는 클라이언트와 맺은 연결을 특정 시간동안 유지합니다. 
연결을 열어놓은 시간동안 여러 요청에 재사용합니다. 
...
<center>이미지 출처, https://www.imperva.com/learn/performance/http-keep-alive/</center><br>

### Keep-Alive 장단점
##### 장점
- No Handshaking 으로 인한 지연 시간 감소합니다.
...
- `Keep-Alive: timeout=5, max=1000`
  ...
  - 최대 5 X 1000 = 5000초 시간동안 연결을 유지할 수 있습니다.
...
네이버로 요청 시 Response Body 가 너무 길어서 `...` 으로 표시하였습니다. 
...
- `Connection: keep-alive` 헤더를 사용합니다.
