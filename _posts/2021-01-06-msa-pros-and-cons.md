...
마이크로 서비스는 실험적인 새로운 기능을 만들어 적용시켜보고 기대치에 부응하지 못하면 다른 마이크로 서비스로 변경하거나 대체할 수 있습니다.

### 확장성에 대한 이야기
마이크로 서비스에 대한 장점에 대해서 이야기할 때 확장성에 대한 이야기는 빠지지 않습니다. 
...
의존성 있는 서비스가 정상적이지 않는 경우에는 테스트가 어렵습니다. 
...
## OPINION
제가 운영하는 시스템이 마이크로 서비스 아키텍처의 모습을 가진지 얼마되지 않아서 아직까지 마이크로 서비스 아키텍처의 장점을 체감하고 있지는 않습니다. 
장점에 대해 공감할 수 있으려면 아직 시간이 필요한 듯 합니다. 
다만 개발하면서 겪은 마이크로 서비스 아키텍처의 단점에 대해 더 공감이 많이 되네요. 
