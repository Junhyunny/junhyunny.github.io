...
![microservice-architecture-1](/images/microservice-architecture-1.JPG){: display="block" margin="auto"}
...
![microservice-architecture-2](/images/microservice-architecture-2.JPG){: display="block" margin="auto"}
