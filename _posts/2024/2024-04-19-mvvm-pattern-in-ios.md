...
내가 익숙한 스프링 프레임워크도 백엔드 애플리케이션을 구성할 때 각 컴포넌트 별로 책임을 나눠 개발한다. 이를 MVC 패턴이라고 한다. SwiftUI 프레임워크에서도 애플리케이션을 구성할 때 동일하게 컴포넌트들 간에 책임을 분할한다. 각 컴포넌트는 다음과 같은 책임을 갖는다.
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/mvvm-pattern-in-ios-01.png" width="80%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/mvvm-pattern-in-ios-02.gif" width="30%" class="image__border">
</div>
