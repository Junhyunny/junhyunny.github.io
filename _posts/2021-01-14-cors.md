...
[이전에 사용하던 블로그에 정리한 내용][before-blog-link]이 있지만 다시 정리해보았습니다. 
...
<p align="center"><img src="/images/cors-1.JPG" width="450"></p>
...
<p align="center"><img src="/images/cors-2.JPG" width="450"></p>
<center>이미지 출처, https://developer.mozilla.org/ko/docs/Web/HTTP/CORS</center><br>
...
<p align="center"><img src="/images/cors-3.JPG" width="450"></p>
<center>이미지 출처, https://developer.mozilla.org/ko/docs/Web/HTTP/CORS</center><br>
...
## OPINION
[이전 블로그에서 작성한 글][before-blog-link]보다 내용이 더 구체적이 되었습니다. 
예전에는 보이지 않던 내용들을 지금은 정리할 수 있는 것을 보니 조금은 성장한 듯 합니다. 
...
[before-blog-link]: https://junhyunny.blogspot.com/2020/01/cors-cross-origin-resource-sharing.html