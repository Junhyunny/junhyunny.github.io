...
API를 사용하는 웹 어플리케이션은 자신의 출처와 동일한 리소스만 불러올 수 있으며, **다른 출처의 리소스를 불러오려면 그 출처에서 올바른 CORS 헤더를 포함한 응답을 반환받아야 합니다.** 
...
- https://foo.example 도메인의 웹 컨텐츠가 https://bar.other 도메인의 컨텐츠를 Preflight 호출
