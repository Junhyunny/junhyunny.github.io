...
* 준영속(detached)
    ...
    * detach(E) 메소드를 통해 영속성 컨텍스트에 분리됩니다.
...
사전적인 용어로는 `Casecade`의 정확한 개념을 파악하기 어려웠습니다. 
JPA에서 `Casecade`는 영속성이 전이된다는 의미입니다. 
