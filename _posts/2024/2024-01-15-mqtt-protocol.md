---
title: "MQTT(Message Queuing Telemetry Transport) 프르토콜"
search: false
category:
  - information
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/mqtt-protocol-03.png" width="80%" class="image__border">
</div>
<center>https://www.hivemq.com/blog/mqtt-essentials-part-6-mqtt-quality-of-service-levels/</center>
...
- [스프링 부트 MQTT 구독자(subscriber) 구현하기][mqtt-subscriber-spring-boot]
