---
title: "자바(Java) 다이렉트 메모리(Direct Memory)"
search: false
category:
  - java
  - jvm
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/direct-memory-in-java-01.png" width="80%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/direct-memory-in-java-02.png" width="100%" class="image__border image__padding">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/direct-memory-in-java-03.png" width="100%" class="image__border">
</div>

### 2.1. ByteBuffer Class

OOM 에러가 발생한 DirectByteBuffer 클래스는 무엇일까? 예전으로 거슬러 올라가면 I/O 작업이 느린 자바의 한계를 극복하기 위해 Java 1.4 버전부터 Java NIO(New I/O) 기능이 추가됐다. 이 `java.nio` 패키지에 포함된 ByteBuffer 추상 클래스의 구현체가 DirectByteBuffer 클래스다. Java NIO가 어떻게 I/O 속도를 개선했는지 관련된 설명은 이 [링크](http://eincs.com/2009/08/java-nio-bytebuffer-channel-file/) 글에 잘 되어 있다.
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/direct-memory-in-java-04.png" width="80%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2024 }}/direct-memory-in-java-05.png" width="60%" class="image__border">
</div>
