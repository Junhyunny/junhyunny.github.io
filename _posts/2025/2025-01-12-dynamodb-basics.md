...
<div align="center">
  <img src="/images/posts/2025/dynamodb-basics-01.png" width="100%" class="image__border">
</div>
...
<div align="center">
  <img src="/images/posts/2025/dynamodb-basics-02.png" width="100%" class="image__border">
</div>
...
<div align="center">
  <img src="/images/posts/2025/dynamodb-basics-03.png" width="100%" class="image__border">
</div>
<center>https://www.youtube.com/watch?v=I7zcRxHbo98</center>

<br/>

특별한 속성이 두 개 존재한다. 이를 키(key)라고 부르며 다음과 같은 두 개가 있다. 

- 파티션 키(partition key)
- 정렬 키(sort key)

파티션 키만 사용할수도 있고, 파티션 키와 정렬 키를 같이 사용하는 것도 가능하다. 파티션 키와 정렬 키를 함께 사용하는 것을 복합 키(composite key)라고 한다. 아이템을 식별할 수 있는 방법이 기본 키(primary key)이기 때문에 파티션 키만 사용하는 경우 파티션 키가 기본 키가 되고, 복합 키를 사용하는 경우 파티션 키와 정렬 키의 조합이 기본 키가 된다.
...
<div align="center">
  <img src="/images/posts/2025/dynamodb-basics-04.gif" width="100%" class="image__border">
</div>
<center>https://www.youtube.com/watch?v=I7zcRxHbo98</center>
...
<div align="center">
  <img src="/images/posts/2025/dynamodb-basics-05.png" width="100%" class="image__border">
</div>
