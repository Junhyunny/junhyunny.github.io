...
해결할만한 이슈를 하나 찾았습니다. 
버그 내용을 보아하니 라이브러리 내부에서 배열을 그대로 `toString` 메소드를 통해 문자열로 변경한 것으로 유추되었습니다.
...
* 배열(array)을 별도로 처리하는 로직이 추가되면 큰 영향 없이 사용할 수 있을 것이라 생각하였습니다. 
...
이슈를 버그로 등록하고 직접 해결하겠다는 답변을 받았습니다. 
...
[@jskim1991][jskim1991-github-link]이 주는 긍정적인 자극은 항상 감사합니다. 
