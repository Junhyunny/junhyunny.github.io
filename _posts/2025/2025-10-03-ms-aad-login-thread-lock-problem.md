...
현재 나는 프로페셔널 서비스(professional service) 팀으로 일하고 있다. 여러 팀들로부터 지원 요청을 받거나 문제가 생겼을 때 이를 해결해주는 역할을 수행한다. 최근 외부 서버와 통신 문제로 인해 시스템 장애가 발생한 케이스에 대한 문의를 받았고, 이 문제를 함께 해결했다. 트러블 슈팅 과정을 정리해 놓으면 좋을 것 같아서 글로 작성했다.
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/ms-aad-login-thread-lock-problem-01.png" width="100%" class="image__border">
</div>
...
<div align="left">
  <img src="{{ site.image_url_2025 }}/ms-aad-login-thread-lock-problem-02.png" width="100%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/ms-aad-login-thread-lock-problem-03.png" width="100%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/ms-aad-login-thread-lock-problem-04.png" width="100%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/ms-aad-login-thread-lock-problem-05.png" width="100%" class="image__border">
</div>
