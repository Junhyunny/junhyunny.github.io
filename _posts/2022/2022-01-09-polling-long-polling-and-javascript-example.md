---
title: "자바스크립트(JavaScript) 폴링(Polling)과 롱 폴링(Long Polling) 구현하기"
search: false
category:
  - information
  - javascript
...
- [스프링(Spring) 롱 폴링(Long Polling) 구현하기][polling-long-polling-and-spring-example-link]
...
<div align="center">
  <img src="{{ site.image_url_2022 }}/polling-long-polling-and-javascript-example-04.png" width="50%" class="image__border">
</div>
