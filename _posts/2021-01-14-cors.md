...
웹 어플리케이션에서 외부 서버의 경로로 AJAX 요청 시 브라우저에서 에러를 내는 현상입니다. 
...
아래 이미지처럼 **http://domain-a.com/** 에서 **http://domain-a.com/** 서버로의 요청은 **same-origin**, **http://domain-b.com/** 서버로의 요청은 **cross-origin** 입니다. 
...
<center>https://developer.mozilla.org/ko/docs/Web/HTTP/CORS</center>
...
(일부만 정리하였으며 구체적인 내용은 [MDN Web Docs - CORS][cors-web-docs-link])
- 메소드
    - GET
    - HEAD
    - POST
