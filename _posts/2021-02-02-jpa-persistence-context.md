...
##### Entity Lifecycle 흐름
<p align="center"><img src="/images/jpa-persistence-context-1.JPG"></p>
...
- 영속(managed)
	- Entity 객체가 EntityManager에 의해 관리되고 있는 상태
...
## OPINION
영속성 컨텍스트가 무엇인지, 이를 통해 JPA EntityManager가 Entity를 어떻게 관리하고 데이터를 저장하는지에 대해 알아보았습니다. 
