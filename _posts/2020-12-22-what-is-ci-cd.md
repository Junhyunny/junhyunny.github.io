...
개발자들이 적용한 변경사항이 테스트를 거쳐 레포지토리에 자동으로 업로드되는 것을 의미합니다.<br>
지속적인 전달을 통해 개발자들은 비즈니스와의 커뮤니케이션 부족 문제를 해결할 수 있습니다. 
운영 팀은 레포지토리에 존재하는 어플리케이션을 실시간으로 production 환경으로 배포할 수 있습니다. 
...
지속적인 제공의 확장된 형태로 어플리케이션을 production 환경으로 배포하는 작업을 자동화한 것을 의미합니다.<br>
