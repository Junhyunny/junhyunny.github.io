...
정형 데이터는 규칙을 정하고 규칙적인 값들이 들어가며, 수치만으로 의미를 파악하기 쉬운 형태의 데이터를 의미합니다. 
...
<p align="center"><img src="/images/nosql-6.JPG" width="80%"></p>
...
사용해보지 않았기에 포스트한 글에 오류가 많을 수도 있습니다.(도움을 주세요.😅) 
