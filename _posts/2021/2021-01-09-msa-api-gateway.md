...
category:
  - msa
last_modified_at: 2026-03-22T12:00:00+09:00
---
...
만약, 유료 API 서비스를 제공한다면 각 사용자마다 API 사용량을 분석해야 한다. API 게이트웨이는 과금을 위한 API 호출 횟수, 클라이언트 IP, API 종류, IN/OUT 트래픽 사용량을 측정하고 기록하는 미터링을 수행하기 좋다. 서비스 업체는 미터링 된 데이터를 기반으로 사용 금액을 정책에 따라 비용을 청구(charging)하는 것이 가능하다.
