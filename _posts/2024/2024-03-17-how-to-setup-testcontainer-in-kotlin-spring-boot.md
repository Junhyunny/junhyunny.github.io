...
- [Do Not Replace Database with @DataJpaTest][do-not-replace-database-link]
...
- @AutoConfigureTestDatabase 애너테이션을 사용해 테스트에서 사용할 데이터베이스를 변경하지 않도록 설정한다.
  ...
  - [Do Not Replace Database with @DataJpaTest][do-not-replace-database-link] 글을 참고하길 바란다.
