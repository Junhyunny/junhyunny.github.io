...
대규모 서버 사이드 개발 및 운영 경험과 간단한 웹 어플리케이션, 모바일 어플리케이션, 서버를 개발한 경험이 있습니다. 
백엔드 서버 개발시 사용 가능한 기술 스택은 Java, Spring Boot, Spring Cloud, Spring Security, JPA / Hibernate, MyBatis 입니다. 
클라이언트를 위한 간단한 웹 어플리케이션, 모바일 어플리케이션 개발은 JavaScript, Vue.js, NativeScript-Vue 프레임워크를 사용합니다.
