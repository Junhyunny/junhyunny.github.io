...
관련 내용들을 조금 더 자세히 알아보도록 하겠습니다.

## Flush mode 옵션

> JPA flush 메소드가 자동으로 호출되는 시점을 결정하는 옵션

다음과 같은 옵션이 있습니다.
- FlushModeType.AUTO, 디폴트(default) 값으로 commit 또는 JQPL 쿼리 실행시 flush 메소드가 호출됩니다.
- FlushModeType.COMMIT, commit 시점에만 flush 메소드가 호출됩니다. 성능 최적화를 위해 필요한 경우에만 사용합니다.
...
그렇기 때문에 JPQL 사용시 flush mode 옵션 값에 따라 같은 코드가 서로 다른 결과를 가지게 됩니다.  
...
<p align="left"><img src="/images/jpa-flush-1.JPG"></p>
<p align="left"><img src="/images/jpa-flush-2.JPG"></p>
<p align="left"><img src="/images/jpa-flush-3.JPG"></p>
...
- 데이터베이스에 저장된 데이터가 **`FlushModeType.AUTO`** 테스트와 다름을 알 수 있습니다.
<p align="left"><img src="/images/jpa-flush-4.JPG"></p>
<p align="left"><img src="/images/jpa-flush-5.JPG"></p>
<p align="left"><img src="/images/jpa-flush-6.JPG"></p>
...
테스트 코드는 [github link][github-link]를 확인해보시기 바랍니다.
