...
{% include codepen.html hash="BaJKgKM" title="Test" %}
...
{% include codepen.html hash="bGapPPV" title="Test" %}
...
{% include codepen.html hash="jOYqgLw" title="Test" %}
...
{% include codepen.html hash="MWryNrV" title="Test" %}
