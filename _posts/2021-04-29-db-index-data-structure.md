...
### B+Tree
B-Tree를 확장한 트리이므로 다음과 같은 이점이 존재합니다.  
...
## OPINION
DB 인덱스를 위한 자료구조에 대한 내용을 정리하는데 꼬박 일주일은 소요된 것 같습니다. 
어려운 내용도 있지만 이해가 되지 않는 부분들도 있어서 읽어보는데 시간이 많이 소요되었습니다. 
글 내용에 틀린 부분이나 미숙한 설명이 있을 수 있습니다. 
한번 쓰고 다시 돌아보지 않는 용도가 아니므로, 지속적으로 글을 다듬어 나갈 예정입니다. 
지식 수준을 더 높혀 지금보다 나은 수준의 설명을 포스트로 작성해 나가도록 하겠습니다. 
