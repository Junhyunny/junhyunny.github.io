...
<div align="center">
  <img src="{{ site.image_url_2021 }}/jpa-persistence-context-01.png" width="80%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2021 }}/jpa-persistence-context-02.png" width="60%" class="image__border">
</div>
...
먼저 준영속 상태 엔티티를 변경했을 때 데이터베이스에 반영되는지 확인하는 테스트를 살펴보자.
