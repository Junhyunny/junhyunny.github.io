...
<div align="center">
  <img src="{{ site.image_url_2025 }}/mcp-and-mcp-server-01.png" width="80%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/mcp-and-mcp-server-02.png" width="65%" class="image__border">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/mcp-and-mcp-server-03.png" width="65%" class="image__border">
</div>
...
`MCP 클라이언트`가 제공하는 세 가지 핵심 기본 요소를 알아보자. MCP 서버는 MCP 클라이언트가 제공하는 기능을 호출할 수 있다. 다음과 같은 기본 요소들이 있다.
...
<div align="center">
  <img src="{{ site.image_url_2025 }}/mcp-and-mcp-server-04.png" width="100%" class="image__border">
</div>
...
- 호스트가 물리적 머신을 의미하지 않고, 클로드 코드, 클로드 데스크탑, VSCode 같은 애플리케이션을 의미한다.
- MCP 클라이언트가 요청만 하는 것이 아니고 서버로부터 요청을 받는다.
- MCP 서버가 반드시 외부에서 동작하는 것이 아니라 MCP 호스트가 설치된 머신에서 실행 중일 수 있다.
