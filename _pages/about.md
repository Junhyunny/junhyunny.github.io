...
안녕하세요. Bekind Labs 소프트웨어 엔지니어 강준현입니다.<br/>
...
- 선생들과 학생들의 평가 및 피드백 프로세스를 위한 도메인 설계 및 구현
...
- iOS 및 웹 애플리케이션 MS AAD OAuth2 인증 프로세스 통합 및 코드 리팩토링
- iOS 및 웹 애플리케이션 서비스 자체 인증 프로세스 구축 및 코드 리팩토링
- JDK21 기반 스프링 서버 애플리케이션 이미지 업로드 시 다이렉트 메모리(direct memory) 누수 현상 분석 및 해결
- 러너 달리기 자세에 대한 스켈레톤 추출 비디오 프로세싱 서비스 구현 및 시스템 통합

##### [Honda] StellarOne 공장 프로세스 모니터링, 2024년 1월 - 3월
