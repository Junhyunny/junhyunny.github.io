...
<div align="center">
  <img src="{{ site.image_url_2021 }}/babel-01.png" width="100%">
</div>
...
<div align="center">
  <img src="{{ site.image_url_2021 }}/babel-02.png" width="100%" class="image__border">
</div>
...
변환 파일은 파일로 만들 수 있다. `-o` 옵션을 사용하면 변환된 코드가 파일로 저장된다.
