...
| 10진법 | 10진법 지수 범위 | 124 나라 자릿수 | 10진법 | 124 나라 자릿수 | 124 나라 자릿수 지수 표현 | 10진법 | 124 나라 자릿수 | 124 나라 자릿수 지수 표현 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 1 | 3^1 이하 | 1 | 6 | (3^2 + 3^1) 이하 | 2 | 11 | (3^2 + 3^1) 이하 | 2 |
| 2 | 3^1 이하 | 1 | 7 | (3^2 + 3^1) 이하 | 2 | 12 | (3^2 + 3^1) 이하 | 2 |
| 3 | 3^1 이하 | 1 | 8 | (3^2 + 3^1) 이하| 2 | 13 | (3^3 + 3^2 + 3^1) 이하 | 3 |
| 4 | (3^2 + 3^1) 이하 | 2 | 9 | (3^2 + 3^1) 이하 | 2 | 14 | (3^3 + 3^2 + 3^1) 이하 | 3 |
| 5 | (3^2 + 3^1) 이하 | 2 | 10 | (3^2 + 3^1) 이하 | 2 | 15 | (3^3 + 3^2 + 3^1) 이하 | 3 |

규칙을 찾았으니 원하는 답을 얻을 수 있도록 규칙을 정리해보겠습니다. 

## 코드 해설
11을 예를 들어 설명해보도록 하겠습니다. 
