...
<div align="center">
  <img src="{{ site.image_url_2021 }}/hadoop-ambari-01.png" width="100%" class="image__border">
</div>
...
### 4.2. Installation error Ambari Admin View

`Ambari Admin View` 설치 중 에러가 발생한다. 특정 의존성의 버전이 맞지 않아 발생하는 것으로 보인다.
...
- 해당 URL을 브라우저를 통해 접근해보면 `Access Denied` 상태이다. 
...
<div align="center">
  <img src="{{ site.image_url_2021 }}/hadoop-ambari-02.png" width="100%" class="image__border">
</div>
